...
import (
	...
	"snippetbox.nathanjsharpe.com/internal/models"
	"snippetbox.nathanjsharpe.com/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), "flash", "Snipped successfully created!")
...
func (app *application) useLogin(w http.ResponseWriter, r *http.Request) {
	data := app.newTemplateData(r)
